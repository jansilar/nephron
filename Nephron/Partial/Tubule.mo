...
equation
  ...
  o[N+1] = port_out.o;
annotation(
    Icon(graphics = {Rectangle(origin = {-11, -1}, lineColor = {52, 101, 164}, fillColor = {52, 101, 164}, fillPattern = FillPattern.Solid, extent = {{-29, 80}, {51, -80}}), Ellipse(origin = {2, 80}, lineColor = {52, 101, 164}, fillColor = {32, 74, 135}, fillPattern = FillPattern.Solid, lineThickness = 0.5, extent = {{-42, 15}, {38, -15}}, endAngle = 360), Ellipse(origin = {2, -82}, lineColor = {52, 101, 164}, fillColor = {52, 101, 164}, fillPattern = FillPattern.Solid, lineThickness = 0.5, extent = {{-42, 15}, {38, -15}}, endAngle = 360), Line(origin = {0.11, 61.65}, points = {{0, 12}, {0, -12}}, thickness = 1, arrow = {Arrow.None, Arrow.Open}, arrowSize = 12), Line(origin = {-0.46, -64.01}, points = {{0, 12}, {0, -12}}, thickness = 1, arrow = {Arrow.None, Arrow.Open}, arrowSize = 12)}, coordinateSystem(initialScale = 0.1)));end Tubule;