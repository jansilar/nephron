...
model AveCOP "calculates avarage coloid osmotic pressure in glomerulus"
  Modelica.Blocks.Interfaces.RealInput inputGFR annotation(
    Placement(visible = true, transformation(origin = {-104, 80}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-92, -60}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput inputRBF annotation(
    Placement(visible = true, transformation(origin = {-104, -80}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-96, 72}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
