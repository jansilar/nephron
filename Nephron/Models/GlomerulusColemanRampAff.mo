...
model GlomerulusColemanRampAff
  ...
  //afferent artery
  parameter Real AffModMin = 0.73;
  parameter Real AffModMax = 1.48;   
  PLT.HydraulicConductance AffC = AffNorm/AffMod "afferent artery conductance";
  parameter PLT.HydraulicConductance AffNorm = colemanConductances.AffNorm*cond2SI "afferent normal conducatance";
  Real AffMod = AffModMin + time*(AffModMax - AffModMin) "afferent relative resistance";
  //efferent artery
  ...
  Physiolibrary.Hydraulic.Components.Conductor afferentArtery(useConductanceInput = true)   annotation(
