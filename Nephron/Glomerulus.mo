...
//volumetric fluxes:
  ...
  parameter PLT.VolumeFlowRate normal_Q_in = CO * 0.2 / N "blood flow into each glomerulus";
  parameter PLT.VolumeFlowRate GFR1 = 180 / 1000 / 24 / 60 / 60 / N "primary urine production per each nephron";

//resistances:
  parameter PLT.HydraulicResistance R_aff = (MAP-normal_P_Glom)/normal_Q_in "afferent arteriol resistance";
  parameter PLT.HydraulicResistance R_eff = (normal_P_Glom - CVP)/(normal_Q_in - GFR1) "efferent arteriol resistance";
